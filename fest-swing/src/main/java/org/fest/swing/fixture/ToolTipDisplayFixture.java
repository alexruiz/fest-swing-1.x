...
/**
 * Understands simulation of user events on a <code>{@link Component}</code> that displays a toolTip, and verification 
 * of the state of such <code>{@link Component}</code>.
 *
 * @author Alex Ruiz
 * @since 1.2
 */
