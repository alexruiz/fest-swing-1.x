...
public class JTableTextComponentEditorCellWriter extends AbstractJTableCellWriter {
  ...
  @RunsInEDT
  private @Nonnull JTextComponent activateEditorWithF2Key(@Nonnull JTable table, int row, int column,
  ...
  @RunsInEDT
  private @Nonnull JTextComponent activateEditorWithDoubleClick(@Nonnull JTable table, int row, int column,
      @Nonnull Point cellLocation) {
  ...
  @RunsInEDT
  private @Nonnull JTextComponent waitForEditorActivation(@Nonnull JTable table, int row, int column) {
