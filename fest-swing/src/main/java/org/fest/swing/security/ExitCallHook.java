...
/**
 * Understands a hook called by {@link NoExitSecurityManager} when an application tries to terminate the current JVM.
 * This hook is called before throwing {@link ExitException}.
 * 
 * @author Alex Ruiz
 */
