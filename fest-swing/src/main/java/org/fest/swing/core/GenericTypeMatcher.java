...
public abstract class GenericTypeMatcher<T extends Component> extends AbstractComponentMatcher {
   ...
   * @return {@code true} if the given {@code Component} is an instance of the generic type of this matcher
   * and matches some search criteria. Otherwise, {@code false}.
   */
  @RunsInCurrentThread
   ...
   * @return {@code true} if the given component matches the defined search criteria; otherwise, {@code false}
   *         .
   */
  @RunsInCurrentThread
