...
class OSIdentifier {
    ...
    OSIdentifier(SystemPropertyReader r) {
        ...
        String mrjVersion = getMRJVersion(osName.contains("os x"));
    ...
    // fest bug in OSIdentifier for Mac OS X.
    private String getMRJVersion(boolean isMac) {
        String mrjV = java.lang.System.getProperty("mrj.version");
        if (isMac && mrjV == null) {
            String osV = java.lang.System.getProperty("os.version");
            if (osV == null) osV = "unknown";
            java.lang.System.setProperty("mrj.version", osV);
            mrjV = osV;
        }
        return mrjV;
    }
