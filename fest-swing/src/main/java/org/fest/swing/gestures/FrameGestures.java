...
import static org.fest.swing.gestures.WindowLikeContainerLocations.*;
...
/**
 * Simulates user input on a <code>{@link Frame}</code>.
 * <p>
 ...
 * @since 1.3
 */
public class FrameGestures extends WindowGestures {

  /**
   * Creates a new </code>{@link FrameGestures}</code>.
   * @param robot the robot to use to simulate user input.
   */
  public FrameGestures(Robot robot) {
    super(robot);
  }
