...
import static org.fest.swing.gestures.WindowLikeContainerLocations.closeLocationOf;
...
/**
 * Simulates user input on a <code>{@link Window}</code>.
 * <p>
 ...
 * @since 1.3
 */
public class WindowGestures extends ContainerGestures {

  /**
   * Creates a new </code>{@link WindowGestures}</code>.
   * @param robot the robot to use to simulate user input.
   */
  public WindowGestures(Robot robot) {
    super(robot);
  }
