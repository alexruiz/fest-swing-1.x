...
/**
 * Tests for <code>{@link ContainerFocusOwnerFinder#focusOwnerOf(Container)}</code>.
 *
 * @author Alex Ruiz
 */
public class ContainerFocusOwnerFinder_focusOwnerOf_Test extends SequentialTestCase {
