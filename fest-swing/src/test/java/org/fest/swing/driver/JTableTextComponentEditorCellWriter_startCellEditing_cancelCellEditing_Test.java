...
/**
 * Tests for <code>{@link JTableTextComponentEditorCellWriter#startCellEditing(javax.swing.JTable, int, int)}</code>
 * and <code>{@link JTableTextComponentEditorCellWriter#cancelCellEditing(javax.swing.JTable, int, int)}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
