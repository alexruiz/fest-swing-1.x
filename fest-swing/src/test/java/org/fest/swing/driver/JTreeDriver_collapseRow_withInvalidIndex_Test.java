...
public class JTreeDriver_collapseRow_withInvalidIndex_Test extends JTreeDriver_TestCase {
  ...
  public JTreeDriver_collapseRow_withInvalidIndex_Test(int invalidRow) {
