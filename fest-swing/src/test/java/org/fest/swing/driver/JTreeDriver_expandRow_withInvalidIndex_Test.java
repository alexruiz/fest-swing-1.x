...
public class JTreeDriver_expandRow_withInvalidIndex_Test extends JTreeDriver_TestCase {
  ...
  public JTreeDriver_expandRow_withInvalidIndex_Test(int invalidRow) {
