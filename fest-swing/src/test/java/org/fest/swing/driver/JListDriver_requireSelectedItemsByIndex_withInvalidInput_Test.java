...
/**
 * Tests for <code>{@link JListDriver#requireSelectedItems(JList, int...)}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JListDriver_requireSelectedItemsByIndex_withInvalidInput_Test extends EDTSafeTestCase {
