...
/**
 * Tests for <code>{@link JListDriver#selectItems(JList, java.util.regex.Pattern[])}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JListDriver_selectItemsByPattern_withInvalidInput_Test extends EDTSafeTestCase {
