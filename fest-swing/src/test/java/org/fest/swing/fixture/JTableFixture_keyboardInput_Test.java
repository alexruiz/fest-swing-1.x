...
/**
 * Tests for methods in {@link JTableFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTableFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JTable> {
