...
/**
 * Tests for methods in {@link JToolBarFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToolBarFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JToolBar> {
