...
/**
 * Test cases for <code>{@link JScrollBarFixture}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public abstract class JScrollBarFixture_TestCase extends ComponentFixture_Implementations_TestCase<JScrollBar> {
  ...
  @Override final JScrollBarDriver driver() {  return driver; }
  @Override final JScrollBar target() { return target; }
  @Override final JScrollBarFixture fixture() { return fixture; }
}
