...
/**
 * Tests for methods in {@link JTreeFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTreeFixture_focusable_Test extends FocusableComponentFixture_TestCase<JTree> {
