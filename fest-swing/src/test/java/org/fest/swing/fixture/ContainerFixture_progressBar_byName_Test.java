...
/**
 * Tests for <code>{@link ContainerFixture#progressBar(String)}</code>.
 *
 * @author Alex Ruiz
 */
public class ContainerFixture_progressBar_byName_Test extends ContainerFixture_progressBar_TestCase {
