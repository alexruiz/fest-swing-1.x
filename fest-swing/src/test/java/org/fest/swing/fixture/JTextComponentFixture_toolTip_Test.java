...
/**
 * Tests for methods in {@link JTextComponentFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTextComponentFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JTextComponent> {
