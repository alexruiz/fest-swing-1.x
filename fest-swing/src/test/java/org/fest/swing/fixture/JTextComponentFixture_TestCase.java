...
/**
 * Test cases for <code>{@link JTextComponentFixture}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public abstract class JTextComponentFixture_TestCase extends ComponentFixture_TestCase<JTextComponent> {
