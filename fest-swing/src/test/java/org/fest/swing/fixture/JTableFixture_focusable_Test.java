...
/**
 * Tests for methods in {@link JTableFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTableFixture_focusable_Test extends FocusableComponentFixture_TestCase<JTable> {
