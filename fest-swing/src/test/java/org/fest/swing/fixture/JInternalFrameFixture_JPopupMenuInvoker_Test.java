 ...
 * {@link JPopupMenuInvokerFixture}.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JInternalFrameFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JInternalFrame> {
  ...
  @Override JInternalFrameDriver driver() {  return driver; }
  @Override JInternalFrame target() { return target; }
  @Override JInternalFrameFixture fixture() { return fixture; }
}
