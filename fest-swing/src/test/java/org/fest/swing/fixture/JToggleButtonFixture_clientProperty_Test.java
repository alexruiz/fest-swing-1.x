...
/**
 * Tests for methods in {@link JToggleButtonFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToggleButtonFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JToggleButton> {
