...
/**
 * Tests for methods in {@link JToggleButtonFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToggleButtonFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JToggleButton> {
