...
/**
 * Tests for methods in {@link JRadioButtonFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JRadioButtonFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JRadioButton> {
