...
/**
 * Tests for methods in {@link JComboBoxFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JComboBoxFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JComboBox> {
