...
/**
 * Tests for methods in {@link JToggleButtonFixture} that are inherited from {@link TwoStateButtonFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToggleButtonFixture_twoStateButton_Test extends TwoStateButtonFixture_TestCase<JToggleButton> {
