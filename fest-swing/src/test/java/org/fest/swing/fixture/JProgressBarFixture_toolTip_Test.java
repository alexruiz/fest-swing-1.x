...
/**
 * Tests for methods in {@link JProgressBarFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Alex Ruiz
 */
public class JProgressBarFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JProgressBar> {
