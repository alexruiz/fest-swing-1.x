...
/**
 * Tests for methods in {@link JComboBoxFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JComboBoxFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JComboBox> {
