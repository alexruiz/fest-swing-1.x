...
/**
 * Tests for methods in {@link JPopupMenuFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JPopupMenuFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JPopupMenu> {
