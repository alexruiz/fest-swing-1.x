...
/**
 * Tests for methods in {@link JTableFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTableFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JTable> {
