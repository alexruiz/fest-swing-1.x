...
/**
 * Tests for methods in {@link JButtonFixture} that are inherited from {@link TextDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JButtonFixture_textDisplay_Test extends TextDisplayFixture_TestCase<JButton> {
