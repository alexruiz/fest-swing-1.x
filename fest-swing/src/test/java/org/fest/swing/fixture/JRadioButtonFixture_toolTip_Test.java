...
/**
 * Tests for methods in {@link JRadioButtonFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JRadioButtonFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JRadioButton> {
