...
/**
 * Tests for methods in {@link JTextComponentFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JTextComponentFixture_focusable_Test extends FocusableComponentFixture_TestCase<JTextComponent> {
