...
/**
 * Tests for methods in {@link JFileChooserFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JFileChooserFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JFileChooser> {
