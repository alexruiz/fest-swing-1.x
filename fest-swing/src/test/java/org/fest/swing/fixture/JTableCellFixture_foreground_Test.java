...
/**
 * Tests for <code>{@link JTableCellFixture#foreground()}</code>.
 *
 * @author Alex Ruiz
 */
public class JTableCellFixture_foreground_Test extends JTableCellFixture_withMockTable_TestCase {

  @Test
  public void should_return_foreground_color() {
