...
/**
 * Tests for methods in {@link JSplitPaneFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSplitPaneFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JSplitPane> {
