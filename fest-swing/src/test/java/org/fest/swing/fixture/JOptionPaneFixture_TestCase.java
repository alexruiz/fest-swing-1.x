...
/**
 * Test cases for {@link JOptionPaneFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public abstract class JOptionPaneFixture_TestCase extends AbstractComponentFixture_Implementations_TestCase<JOptionPane> {
  ...
  @Override
  final JOptionPaneDriver driver() {
    return driver;
  }

  @Override
  final JOptionPane target() {
    return target;
  }

  @Override
  final JOptionPaneFixture fixture() {
    return fixture;
  }
}
