...
/**
 * Tests for methods in {@link JSpinnerFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSpinnerFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JSpinner> {
