...
/**
 * Tests for methods in {@link JToolBarFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToolBarFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JToolBar> {
