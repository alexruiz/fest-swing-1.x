...
/**
 * Tests for methods in {@link JScrollBarFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JScrollBarFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JScrollBar> {
