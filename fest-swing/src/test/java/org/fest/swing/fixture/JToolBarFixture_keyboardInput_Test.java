...
/**
 * Tests for methods in {@link JToolBarFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToolBarFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JToolBar> {
