...
/**
 * Tests for <code>{@link JTableHeaderFixture#clickColumn(String, org.fest.swing.core.MouseClickInfo)}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTableHeaderFixture_clickColumn_byName_withMouseClickInfo_Test extends JTableHeaderFixture_TestCase {
