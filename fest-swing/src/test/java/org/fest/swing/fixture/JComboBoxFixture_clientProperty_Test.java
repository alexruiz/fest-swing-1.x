...
/**
 * Tests for methods in {@link JComboBoxFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JComboBoxFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JComboBox> {
