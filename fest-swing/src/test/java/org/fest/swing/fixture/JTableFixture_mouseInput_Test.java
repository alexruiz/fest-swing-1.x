...
/**
 * Tests for methods in {@link JTableFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTableFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JTable> {
