...
/**
 * Tests for methods in {@link JLabelFixture} that are inherited from {@link TextDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JLabelFixture_textDisplay_Test extends TextDisplayFixture_TestCase<JLabel> {
