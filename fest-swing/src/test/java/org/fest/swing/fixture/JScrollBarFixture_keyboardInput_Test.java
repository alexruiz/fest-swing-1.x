...
/**
 * Tests for methods in {@link JScrollBarFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JScrollBarFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JScrollBar> {
