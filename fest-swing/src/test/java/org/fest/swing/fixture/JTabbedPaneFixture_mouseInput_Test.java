...
/**
 * Tests for methods in {@link JTabbedPaneFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTabbedPaneFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JTabbedPane> {
