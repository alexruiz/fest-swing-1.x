...
/**
 * Tests for methods in {@link JToggleButtonFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToggleButtonFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JToggleButton> {
