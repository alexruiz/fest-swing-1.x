...
/**
 * Tests for <code>{@link JTableCellFixture#requireNotEditable()}</code>.
 *
 * @author Alex Ruiz
 */
public class JTableCellFixture_requireNotEditable_Test extends JTableCellFixture_withMockTable_TestCase {
