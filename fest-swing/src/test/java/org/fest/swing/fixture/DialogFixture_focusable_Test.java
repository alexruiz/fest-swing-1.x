...
/**
 * Tests for methods in <code>{@link DialogFixture}</code> that are inherited from {@link FocusableComponentFixture}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class DialogFixture_focusable_Test extends FocusableComponentFixture_TestCase<Dialog> {
