...
/**
 * Tests for <code>{@link WindowFixture#WindowFixture(Class)}</code>.
 *
 * @author Alex Ruiz
 */
public class WindowFixture_constructorWithType_Test extends WindowFixture_TestCase {
  ...
  @Test
  public void should_create_WindowFixture_with_given_type() {
