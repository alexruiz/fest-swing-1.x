...
/**
 * Test cases for {@link JSliderFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public abstract class JSliderFixture_TestCase extends AbstractComponentFixture_Implementations_TestCase<JSlider> {
  ...
  @Override
  final JSliderDriver driver() {
    return driver;
  }

  @Override
  final JSlider target() {
    return target;
  }
