...
/**
 * Tests for methods in {@link JSliderFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSliderFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JSlider> {
