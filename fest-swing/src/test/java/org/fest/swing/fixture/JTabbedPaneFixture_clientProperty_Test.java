...
/**
 * Tests for methods in {@link JTabbedPaneFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTabbedPaneFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JTabbedPane> {
