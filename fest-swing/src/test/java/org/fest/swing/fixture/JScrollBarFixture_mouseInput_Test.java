...
/**
 * Tests for methods in {@link JScrollBarFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JScrollBarFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JScrollBar> {
