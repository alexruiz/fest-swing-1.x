...
/**
 * Tests for methods in {@link JCheckBoxFixture} that are inherited from {@link TextDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JCheckBoxFixture_textDisplay_Test extends TextDisplayFixture_TestCase<JCheckBox> {
