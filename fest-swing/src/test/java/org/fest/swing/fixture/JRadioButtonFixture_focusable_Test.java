...
/**
 * Tests for methods in {@link JRadioButtonFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JRadioButtonFixture_focusable_Test extends FocusableComponentFixture_TestCase<JRadioButton> {
