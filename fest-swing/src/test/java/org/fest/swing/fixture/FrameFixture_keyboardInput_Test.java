...
/**
 * Tests for methods in {@link FrameFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class FrameFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<Frame> {
