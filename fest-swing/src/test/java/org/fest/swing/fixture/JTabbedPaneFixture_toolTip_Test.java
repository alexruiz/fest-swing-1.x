...
/**
 * Tests for methods in {@link JTabbedPaneFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTabbedPaneFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JTabbedPane> {
