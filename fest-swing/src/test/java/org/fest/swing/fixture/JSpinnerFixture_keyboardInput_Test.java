...
/**
 * Tests for methods in {@link JSpinnerFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSpinnerFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JSpinner> {
