...
/**
 * Tests for methods in {@link JRadioButtonFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JRadioButtonFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JRadioButton> {
