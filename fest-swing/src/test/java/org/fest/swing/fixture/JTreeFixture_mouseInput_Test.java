...
/**
 * Tests for methods in {@link JTreeFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTreeFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JTree> {
