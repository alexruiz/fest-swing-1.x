...
/**
 * Tests for methods in {@link JScrollBarFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JScrollBarFixture_focusable_Test extends FocusableComponentFixture_TestCase<JScrollBar> {
