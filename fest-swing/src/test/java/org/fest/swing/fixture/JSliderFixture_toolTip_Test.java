...
/**
 * Tests for methods in {@link JSliderFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSliderFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JSlider> {
