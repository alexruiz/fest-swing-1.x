...
public abstract class JComboBoxFixture_TestCase extends ComponentFixture_Implementations_TestCase<JComboBox> {
  ...
  @Override final JComboBoxDriver driver() {  return driver; }
  @Override final JComboBox target() { return target; }
  @Override final JComboBoxFixture fixture() { return fixture; }
}
