...
/**
 * Tests for <code>{@link WindowFixture#WindowFixture(Robot, java.awt.Window)}</code>.
 *
 * @author Alex Ruiz
 */
public class WindowFixture_constructorWithRobotAndWindow_Test extends WindowFixture_TestCase {
