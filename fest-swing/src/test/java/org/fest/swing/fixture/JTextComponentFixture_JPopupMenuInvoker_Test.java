...
/**
 * Tests for methods in {@link JTextComponentFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTextComponentFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JTextComponent> {
