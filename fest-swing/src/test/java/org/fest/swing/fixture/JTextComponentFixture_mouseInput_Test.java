...
/**
 * Tests for methods in {@link JTextComponentFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTextComponentFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JTextComponent> {
