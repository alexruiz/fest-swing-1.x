...
/**
 * Tests for <code>{@link JTableCellFixture#requireEditable()}</code>.
 *
 * @author Alex Ruiz
 */
public class JTableCellFixture_requireEditable_Test extends JTableCellFixture_withMockTable_TestCase {
