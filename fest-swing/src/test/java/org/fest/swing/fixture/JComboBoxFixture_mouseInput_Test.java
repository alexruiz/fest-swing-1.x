...
/**
 * Tests for methods in {@link JComboBoxFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JComboBoxFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JComboBox> {
