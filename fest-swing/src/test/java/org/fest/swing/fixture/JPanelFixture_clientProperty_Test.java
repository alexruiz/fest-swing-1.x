...
/**
 * Tests for methods in {@link JPanelFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JPanelFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JPanel> {
