...
/**
 * Tests for methods in {@link JListFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JListFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JList> {
