...
/**
 * Tests for methods in <code>{@link DialogFixture}</code> that are inherited from {@link MouseInputSimulationFixture}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class DialogFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<Dialog> {
