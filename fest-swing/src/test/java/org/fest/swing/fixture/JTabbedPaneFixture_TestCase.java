...
/**
 * Test cases for <code>{@link JTabbedPaneFixture}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public abstract class JTabbedPaneFixture_TestCase extends ComponentFixture_Implementations_TestCase<JTabbedPane> {
  ...
  @Override final JTabbedPaneDriver driver() {  return driver; }
  @Override final JTabbedPane target() { return target; }
  @Override final JTabbedPaneFixture fixture() { return fixture; }
}
