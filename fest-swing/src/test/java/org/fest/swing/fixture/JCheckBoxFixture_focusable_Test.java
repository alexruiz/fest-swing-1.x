...
/**
 * Tests for methods in {@link JCheckBoxFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JCheckBoxFixture_focusable_Test extends FocusableComponentFixture_TestCase<JCheckBox> {
