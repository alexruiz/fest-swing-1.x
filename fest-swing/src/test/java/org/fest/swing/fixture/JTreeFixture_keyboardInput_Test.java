...
/**
 * Tests for methods in {@link JTreeFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTreeFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JTree> {
