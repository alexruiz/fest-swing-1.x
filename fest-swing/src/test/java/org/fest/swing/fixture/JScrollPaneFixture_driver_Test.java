...
/**
 * Tests for <code>{@link JScrollPaneFixture#driver(org.fest.swing.driver.JScrollPaneDriver)}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JScrollPaneFixture_driver_Test extends EDTSafeTestCase {
  ...
  public void setUp() {
    ...
    fixture = new JScrollPaneFixture(createMock(Robot.class), target);
  }
