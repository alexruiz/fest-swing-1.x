...
/**
 * Tests for <code>{@link JComboBoxFixture#driver(org.fest.swing.driver.JComboBoxDriver)}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JComboBoxFixture_driver_Test extends EDTSafeTestCase {
