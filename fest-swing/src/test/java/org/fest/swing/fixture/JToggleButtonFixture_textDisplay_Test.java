...
/**
 * Tests for methods in {@link JToggleButtonFixture} that are inherited from {@link TextDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToggleButtonFixture_textDisplay_Test extends TextDisplayFixture_TestCase<JToggleButton> {
