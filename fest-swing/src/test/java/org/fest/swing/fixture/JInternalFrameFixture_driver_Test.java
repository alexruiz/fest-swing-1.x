...
/**
 * Tests for <code>{@link JInternalFrameFixture#driver(org.fest.swing.driver.JInternalFrameDriver)}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JInternalFrameFixture_driver_Test extends EDTSafeTestCase {
  ...
  public void setUp() {
    ...
    fixture = new JInternalFrameFixture(createMock(Robot.class), target);
  }
