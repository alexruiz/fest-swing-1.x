...
/**
 * Tests for methods in {@link JListFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JListFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JList> {
