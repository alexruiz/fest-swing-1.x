...
/**
 * Tests for methods in {@link JListFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JListFixture_focusable_Test extends FocusableComponentFixture_TestCase<JList> {
