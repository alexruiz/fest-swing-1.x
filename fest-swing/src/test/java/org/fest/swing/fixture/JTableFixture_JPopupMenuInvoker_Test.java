...
/**
 * Tests for methods in {@link JTableFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTableFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JTable> {
