...
/**
 * Tests for methods in {@link JSplitPaneFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSplitPaneFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JSplitPane> {
