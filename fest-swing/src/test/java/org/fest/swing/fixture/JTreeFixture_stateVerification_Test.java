...
/**
 * Tests for methods in {@link JTreeFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTreeFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JTree> {
