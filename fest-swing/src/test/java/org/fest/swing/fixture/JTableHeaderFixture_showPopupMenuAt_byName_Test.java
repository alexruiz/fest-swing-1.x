...
/**
 * Tests for <code>{@link JTableHeaderFixture#showPopupMenuAt(String)}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTableHeaderFixture_showPopupMenuAt_byName_Test extends JTableHeaderFixture_showPopupMenuAt_TestCase {
