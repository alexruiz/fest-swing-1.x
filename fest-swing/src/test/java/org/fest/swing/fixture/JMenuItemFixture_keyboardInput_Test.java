...
/**
 * Tests for methods {@link JMenuItemFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JMenuItemFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JMenuItem> {
