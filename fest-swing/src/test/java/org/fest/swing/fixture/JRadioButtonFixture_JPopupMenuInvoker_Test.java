...
/**
 * Tests for methods in {@link JRadioButtonFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JRadioButtonFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JRadioButton> {
