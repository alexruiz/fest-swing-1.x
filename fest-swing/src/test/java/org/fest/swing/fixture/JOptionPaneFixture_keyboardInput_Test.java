...
/**
 * Tests for methods in {@link JOptionPaneFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JOptionPaneFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JOptionPane> {
