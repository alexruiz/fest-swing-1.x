...
/**
 * Tests for methods in {@link JSplitPaneFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSplitPaneFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JSplitPane> {
