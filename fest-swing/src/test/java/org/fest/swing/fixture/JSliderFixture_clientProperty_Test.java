...
/**
 * Tests for methods in {@link JSliderFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSliderFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JSlider> {
