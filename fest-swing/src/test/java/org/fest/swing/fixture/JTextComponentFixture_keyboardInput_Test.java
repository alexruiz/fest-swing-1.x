...
/**
 * Tests for methods in {@link JTextComponentFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JTextComponentFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JTextComponent> {
