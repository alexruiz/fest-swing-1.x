...
/**
 * Tests for methods in {@link JScrollBarFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JScrollBarFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JScrollBar> {
