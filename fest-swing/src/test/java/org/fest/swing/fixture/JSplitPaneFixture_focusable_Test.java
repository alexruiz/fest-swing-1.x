...
/**
 * Tests for methods in {@link JSplitPaneFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JSplitPaneFixture_focusable_Test extends FocusableComponentFixture_TestCase<JSplitPane> {
