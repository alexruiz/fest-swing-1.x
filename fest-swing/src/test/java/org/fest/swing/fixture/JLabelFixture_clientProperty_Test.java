...
/**
 * Tests for methods in {@link JLabelFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JLabelFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JLabel> {
