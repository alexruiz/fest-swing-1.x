...
/**
 * Tests for methods in {@link JRadioButtonFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JRadioButtonFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JRadioButton> {
