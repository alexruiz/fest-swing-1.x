...
/**
 * Tests for methods in {@link JButtonFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JButtonFixture_focusable_Test extends FocusableComponentFixture_TestCase<JButton> {
