...
/**
 * Tests for methods in {@link JPopupMenuFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JPopupMenuFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JPopupMenu> {
