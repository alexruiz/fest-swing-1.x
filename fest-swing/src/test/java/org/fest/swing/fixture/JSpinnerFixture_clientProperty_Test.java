...
/**
 * Tests for methods in {@link JSpinnerFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSpinnerFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JSpinner> {
