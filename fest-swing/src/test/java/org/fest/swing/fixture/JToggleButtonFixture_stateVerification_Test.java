...
/**
 * Tests for methods in {@link JToggleButtonFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToggleButtonFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JToggleButton> {
