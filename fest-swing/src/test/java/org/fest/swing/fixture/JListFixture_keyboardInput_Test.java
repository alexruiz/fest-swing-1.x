...
/**
 * Tests for methods in {@link JListFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JListFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JList> {
