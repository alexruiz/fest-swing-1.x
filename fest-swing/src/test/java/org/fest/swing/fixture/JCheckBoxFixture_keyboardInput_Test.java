...
/**
 * Tests for methods in {@link JCheckBoxFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JCheckBoxFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JCheckBox> {
