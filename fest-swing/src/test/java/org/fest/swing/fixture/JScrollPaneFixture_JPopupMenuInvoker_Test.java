...
/**
 * Tests for methods in {@link JScrollPaneFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JScrollPaneFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<JScrollPane> {
