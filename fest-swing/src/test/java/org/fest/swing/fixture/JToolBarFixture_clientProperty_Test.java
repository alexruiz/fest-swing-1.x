...
/**
 * Tests for methods in {@link JToolBarFixture} that are inherited from {@link ClientPropertyStorageFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToolBarFixture_clientProperty_Test extends ClientPropertyStorageFixture_TestCase<JToolBar> {
