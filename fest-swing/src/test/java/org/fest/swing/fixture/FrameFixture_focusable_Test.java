...
/**
 * Tests for methods in <code>{@link FrameFixture}</code> that are inherited from {@link FocusableComponentFixture}.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class FrameFixture_focusable_Test extends FocusableComponentFixture_TestCase<Frame> {
