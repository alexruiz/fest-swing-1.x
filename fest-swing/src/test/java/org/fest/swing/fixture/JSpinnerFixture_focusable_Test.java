...
/**
 * Tests for methods in {@link JSpinnerFixture} that are inherited from {@link FocusableComponentFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class JSpinnerFixture_focusable_Test extends FocusableComponentFixture_TestCase<JSpinner> {
