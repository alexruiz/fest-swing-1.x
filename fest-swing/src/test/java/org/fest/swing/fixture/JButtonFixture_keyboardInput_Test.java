...
/**
 * Tests for methods in {@link JButtonFixture} that are inherited from {@link KeyboardInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JButtonFixture_keyboardInput_Test extends KeyboardInputSimulationFixture_TestCase<JButton> {
