...
/**
 * Tests for methods in {@link JToolBarFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToolBarFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JToolBar> {
