...
/**
 * Tests for methods in {@link JListFixture} that are inherited from {@link ToolTipDisplayFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JListFixture_toolTip_Test extends ToolTipDisplayFixture_TestCase<JList> {
