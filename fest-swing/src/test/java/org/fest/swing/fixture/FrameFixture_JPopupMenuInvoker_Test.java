...
/**
 * Tests for methods in {@link FrameFixture} that are inherited from {@link JPopupMenuInvokerFixture}.
 * 
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class FrameFixture_JPopupMenuInvoker_Test extends JPopupMenuInvokerFixture_TestCase<Frame> {
