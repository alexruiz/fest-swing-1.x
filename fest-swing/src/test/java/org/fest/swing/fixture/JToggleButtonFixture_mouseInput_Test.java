...
/**
 * Tests for methods in {@link JToggleButtonFixture} that are inherited from {@link MouseInputSimulationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JToggleButtonFixture_mouseInput_Test extends MouseInputSimulationFixture_TestCase<JToggleButton> {
