...
/**
 * Tests for methods in {@link JSpinnerFixture} that are inherited from {@link StateVerificationFixture}.
 * 
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class JSpinnerFixture_stateVerification_Test extends StateVerificationFixture_TestCase<JSpinner> {
