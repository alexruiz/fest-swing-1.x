...
/**
 * Tests for <code>{@link ComponentShowingQuery#isShowing(java.awt.Component)}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class ComponentShowingQuery_isShowing_Test extends SequentialTestCase {
