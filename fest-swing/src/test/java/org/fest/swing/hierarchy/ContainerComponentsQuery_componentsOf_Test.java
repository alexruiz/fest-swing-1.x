...
/**
 * Tests for <code>{@link ContainerComponentsQuery#componentsOf(java.awt.Container)}</code>.
 *
 * @author Alex Ruiz
 * @author Yvonne Wang
 */
public class ContainerComponentsQuery_componentsOf_Test extends SequentialTestCase {
