...
public class Arrays_nonNullElements_Test {
  ...
  public void should_return_an_array_without_null_elements() {
    String[] arrayWithNullElements = array("Frodo", null, "Sam", null);
    String[] expectedArray = array("Frodo", "Sam");
    String[] arrayWithoutNullElements = nonNullElements(arrayWithNullElements);
    for (int i = 0; i < expectedArray.length; i++) {
      assertEquals(expectedArray[i], arrayWithoutNullElements[i]);
    }
  }
