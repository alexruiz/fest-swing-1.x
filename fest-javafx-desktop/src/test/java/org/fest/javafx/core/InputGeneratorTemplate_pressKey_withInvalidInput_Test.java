...
/**
 * Tests for <code>{@link InputGeneratorTemplate#pressKey(javafx.scene.input.KeyCode)}</code>.
 *
 * @author Alex Ruiz
 */
public class InputGeneratorTemplate_pressKey_withInvalidInput_Test {
