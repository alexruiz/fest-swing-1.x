...
{
    public class Spinner : Component, IHasSelection<Spinner>, IHasCoordinates<Spinner>
    {
        private const string TYPE_STRING = "spinner";
        private readonly List<string> _selections = new List<string>();
        private Coordinates _coordinates;

        public Spinner(string pName) : base(pName, TYPE_STRING)
        {}

        public Spinner(string pName, string pText) : base(pName, pText, TYPE_STRING)
        {}

        #region Implementation of IHasSelection<Spinner>
        ...
        public Spinner AddItem(object pItem)
        {
        ...
        public Spinner AddItems(params object[] pItems)
        {
        ...
        public Spinner RemoveItem(object pItem)
        {
        ...
        public Spinner RemoveItems(params object[] pItems)
        {
        ...
        #region Implementation of IHasCoordinates<Spinner>
        ...
        public Spinner Coordinates(Coordinates pCoordinates)
        {
