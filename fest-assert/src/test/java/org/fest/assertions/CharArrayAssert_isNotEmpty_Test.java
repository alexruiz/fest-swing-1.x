 ...
 * @author Alex Ruiz
 */
public class CharArrayAssert_isNotEmpty_Test extends GroupAssert_isNotEmpty_TestCase<char[]> {
  ...
  @Override protected char[] emptyGroup() {
    return emptyCharArray();
  }

  @Override protected char[] notEmptyGroup() {
    return empty;
  }
}
