...
// TODO konermann: remove ASSERT_TYPE, refactor to a common naming scheme of abstract methods
public abstract class GenericAssert_isEqualTo_TestBase<VALUE_TYPE, ASSERT_TYPE extends GenericAssert<VALUE_TYPE>> implements GenericAssert_isEqualTo_TestCase {
  ...
  public void should_fail_if_actual_and_expected_are_not_equal() {
    expectAssertionError("expected:<" + messageStringRepresentingY() + "> but was:<" + messageStringRepresentingX() + ">")
      .on(new CodeToTest() {
        public void run() {
  ...
  public void should_fail_and_display_description_of_assertion_if_actual_and_expected_are_not_equal() {
    expectAssertionError("[A Test] expected:<" + messageStringRepresentingY() + "> but was:<" + messageStringRepresentingX() + ">")
      .on(new CodeToTest() {
        public void run() {
  ...
  public void should_fail_with_custom_message_ignoring_description_of_assertion_if_actual_and_expected_are_not_equal() {
    expectAssertionError("My custom message").on(new CodeToTest() {
      public void run() {
        createAssertForActual(actualValueX()).as("A Test")
          .overridingErrorMessage("My custom message")
          .isEqualTo(actualValueY());
      }
    });
  }
}
