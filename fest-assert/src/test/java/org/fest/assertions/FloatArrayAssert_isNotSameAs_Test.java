...
/**
 * Tests for <code>{@link FloatArrayAssert#isNotSameAs(float[])}</code>.
 *
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class FloatArrayAssert_isNotSameAs_Test extends GenericAssert_isNotSameAs_TestCase<float[]> {
  ...
  public static void setUpOnce() {
    notNullValue = floatArray(8f);
    notSameValue = emptyFloatArray();
  }
