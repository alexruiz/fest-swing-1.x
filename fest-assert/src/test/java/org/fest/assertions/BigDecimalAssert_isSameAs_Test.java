...
/**
 * Tests for <code>{@link BigDecimalAssert#isSameAs(BigDecimal)}</code>.
 *
 * @author David DIDIER
 * @author Ted M. Young
 * @author Yvonne Wang
 * @author Alex Ruiz
 */
public class BigDecimalAssert_isSameAs_Test extends GenericAssert_isSameAs_TestCase<BigDecimal> {
